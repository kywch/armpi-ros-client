...
class ArmpiKinematics:
    ...
    def adjust_ee_pos_by(self, delta_x, delta_y, delta_z):
        ...
        for k, v in target_dict.items():
            if v < MIN_SERVO_STATE:
                target_dict[k] = MIN_SERVO_STATE
            elif v > MAX_SERVO_STATE:
                target_dict[k] = MAX_SERVO_STATE
    ...
    def adjust_ee_roll_by(self, delta_roll):
        ...
        roll_servo_state = self._gripper_roll_servo_state
        ...
        # Valid change: Update and return the target servo states
        self._gripper_roll_servo_state = roll_servo_state
...
if __name__ == "__main__":
    ...
    INITIAL_ARM_POSITIONS = ((6, 500), (5, 750), (4, 1000), (3, 350), (2, 200), (1, 1000))
    NEUTRAL_ARM_POSITIONS = ((6, 500), (5, 500), (4, 500), (3, 500), (2, 500), (1, 500))
    FORWARD_ARM_POSITIONS = ((6, 500), (5, 200), (4, 850), (3, 730), (2, 500), (1, 1000))

    FORWARD_ARM_POSITIONS = ((6, 500), (5, 500), (4, 850), (3, 730), (2, 500), (1, 1000))

    control_servos(joints_pub, FORWARD_ARM_POSITIONS)
